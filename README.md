...
👉*Dare IT Challenges* - A project created as part of an introductory course for an automated tester. It covered topics such as writing tests <br>
  <p> in Selenium with Python, testing using the Robot framework, writing test cases, and generating error reports.
